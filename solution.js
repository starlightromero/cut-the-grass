...
function setup() {
  ...
  noStroke();
  // Set saturation and brightness globally so we can experiment with
  // different color palettes as we go without having to change multiple things
  globalS = 90;
  globalB = 90;
  // We'll keep background color in a variable so we can modify it in
  // other functions.
